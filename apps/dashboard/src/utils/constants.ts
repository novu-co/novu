...
export const DEFAULT_CONTROL_THROTTLE_AMOUNT = 5;
export const DEFAULT_CONTROL_THROTTLE_TIME_VALUE = 1;
export const DEFAULT_CONTROL_THROTTLE_TIME_UNIT = TimeUnitEnum.HOURS;
