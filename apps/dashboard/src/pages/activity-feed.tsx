    ...
    <div className="px-3 py-2">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-foreground-600 font-mono text-xs">{formatDate(activity.createdAt)} UTC</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-foreground-950 text-xs font-medium">Status</span>
          <span className="text-success font-mono text-xs">{getActivityStatus(activity.jobs)}</span>
        </div>
      </div>
    </div>
  );
